...
def Text1(text,portrait):
    ...
    select.MakeTextSquare()
    select.OnePortrait(portrait)
    select.TextboxMaker.goto(-550,-25)
    select.TextboxMaker.write(text,False, align="left",font=(gamefont, round(20*FontMul), "bold"))
    screensetup.BattleScreen.tracer(1)

def Text2(text,portrait1,portrait2):
    screensetup.BattleScreen.tracer(0)
    select.MakeTextSquare()
    select.TwoPortrait(portrait1,portrait2)
    select.TextboxMaker.goto(-550,-25)
    select.TextboxMaker.write(text,False, align="left",font=(gamefont, round(20*FontMul), "bold"))
    screensetup.BattleScreen.tracer(1)
...
def line2(text):
    screensetup.BattleScreen.tracer(0)
    select.TextboxMaker.goto(-550,-50)
    select.TextboxMaker.write(text,False, align="left",font=(gamefont, round(20*FontMul), "bold"))
    screensetup.BattleScreen.tracer(1)

def line3(text):
    screensetup.BattleScreen.tracer(0)
    select.TextboxMaker.goto(-550,-75)
    select.TextboxMaker.write(text,False, align="left",font=(gamefont, round(20*FontMul), "bold"))
    screensetup.BattleScreen.tracer(1)
...
pernicious = current_directory+"/Portraits/pernicious_big.gif"
...
def Cutscene():
    ...
    if Chapter == None:
        ...
        if CutsceneIndex == 0:
            ...
            turtle.register_shape(current_directory+"/Portraits/protonarm_big.gif")
            Text2("???: That is the mark of the Proto-Xuirs.", units.Tluc.Portrait,current_directory+"/Portraits/protonarm_big.gif")
            CutsceneIndex += 1
            (screensetup.BattleScreen).onkey(Cutscene, "space")
        elif CutsceneIndex == 35:
        ...
        if CutsceneIndex == 0:
            ...
            if CutsceneIndex == 20:
                turtle.register_shape(current_directory+"/Portraits/revolt.gif")
                Text2("???: ...",units.Proton.Portrait,current_directory+"/Portraits/revolt.gif")
                CutsceneIndex += 1
                (screensetup.BattleScreen).onkey(Cutscene, "space")
            elif CutsceneIndex == 21:
                Text2("???: You've helped me greatly, Proton.",units.Proton.Portrait,current_directory+"/Portraits/revolt.gif")
                CutsceneIndex += 1
                (screensetup.BattleScreen).onkey(Cutscene, "space")
            elif CutsceneIndex == 22:
                Text2("Proton: Who are you?.",units.Proton.Portrait,current_directory+"/Portraits/revolt.gif")
                CutsceneIndex += 1
                (screensetup.BattleScreen).onkey(Cutscene, "space")
            elif CutsceneIndex == 23:
                Text2("???: I am Revolt, and you have just defeated Dael and his army for me.",units.Proton.Portrait,current_directory+"/Portraits/revolt.gif")
                CutsceneIndex += 1
                (screensetup.BattleScreen).onkey(Cutscene, "space")
            elif CutsceneIndex == 24:
                Text2("Revolt: I'm in a very good mood today, so I'll grant you this...",units.Proton.Portrait,current_directory+"/Portraits/revolt.gif")
                CutsceneIndex += 1
                (screensetup.BattleScreen).onkey(Cutscene, "space")
            elif CutsceneIndex == 25:
        ...
        if CutsceneIndex == 0:
            ...
            units.Proton.Portrait = current_directory+"/Portraits/proton_big2.gif"
        ...
        if CutsceneIndex == 0:
            ...
            turtle.register_shape(current_directory+"/Portraits/pernicious_big.gif")
